...
public class Main {
    ...
    private final static IMobileContactService service = new MobileContactsServiceImpl(dao);
    ...
    public static void processWithChoice(String choice) {
        ...
        switch (choice) {
            ...
            case "2":
                ...
                id = scanner.nextLong();
                System.out.println("Παρακάλω εισάγετε τα στοιχέια της νέας επαφής");
                contact = getMobileContact();
    ...
    public static List<MobileContactReadOnlyDTO> getMobileContacts() {
        ...
        return mapToContactReadOnlyDto(contacts);
    }
    ...
    private static List<MobileContactReadOnlyDTO> mapToContactReadOnlyDto(List<MobileContact> contacts) {
